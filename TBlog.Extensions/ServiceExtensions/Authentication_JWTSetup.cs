...
namespace TBlog.Extensions
{
    ...
    public static class Authentication_JWTSetup
    {
        public static void AddAuthentication_JWTSetup(this IServiceCollection services)
        {
            ...
            if (ApiConfig.IdentityServer4.Enabled || ApiConfig.JwtBearer.Enabled == false) return;
                 ...
                 o.Events = new JwtBearerEvents
                 {
                     ...
                     OnAuthenticationFailed = context =>
                     {
                         ...
                         if (token.IsNotEmptyOrNull() && jwtHandler.CanReadToken(token))
                         {
                             ...
                             if (jwtToken.Issuer != ApiConfig.JwtBearer.Issuer)
                             {
                                 context.Response.Headers.Add("Token-Error-Iss", "issuer is wrong!");
                             }

                             if (jwtToken.Audiences.FirstOrDefault() != ApiConfig.JwtBearer.Audience)
                             {
